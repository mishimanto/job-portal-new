...
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">View system activity and logs</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        <p class="text-sm font-medium text-blue-100">Log Files</p>
                        <p class="text-2xl font-bold text-white">4</p>
                    </div>
                </div>
            </div>

            <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl shadow p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5">
                        <p class="text-sm font-medium text-green-100">Total Entries</p>
                        <p class="text-2xl font-bold text-white">1,248</p>
                    </div>
                </div>
            </div>

            <div class="bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl shadow p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5">
                        <p class="text-sm font-medium text-yellow-100">Errors</p>
                        <p class="text-2xl font-bold text-white">12</p>
                    </div>
                </div>
            </div>

            <div class="bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl shadow p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5">
                        <p class="text-sm font-medium text-purple-100">Today</p>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Log Files</h3>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">laravel.log</div>
                                            <div class="text-sm text-gray-500">Application log</div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">error.log</div>
                                            <div class="text-sm text-gray-500">Error log</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">access.log</div>
                                            <div class="text-sm text-gray-500">Access log</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <div class="flex items-start space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-500">
                                {{ now()->subMinutes($i * 30)->format('M d, Y h:i A') }}
                            </p>
                        </div>
                        <div class="text-xs text-gray-400">
                            {{ now()->subMinutes($i * 30)->diffForHumans() }}
                        </div>
                    </div>
                    @endfor
                </div>
